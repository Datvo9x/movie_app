...
class FastReplace extends StatefulWidget {
  String id, uid, name, photoUrl, nameFast, videoFast, desFast, cateFast;
  int view;
  FastReplace({
    Key? key,
    required this.id,
    ...
    required this.nameFast,
    required this.view,
    required this.videoFast,
    required this.desFast,
    required this.cateFast,
  }) : super(key: key);

  @override
  State<FastReplace> createState() => _FastReplaceState();
}

class _FastReplaceState extends State<FastReplace> {
  int _pageIndex = 0;
                                                                                            ...
                                                                                            child: Row(
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                GestureDetector(
                                                                                                  ...
                                                                                                  onTap: () async {
                                                                                                    await getcmt.doc(widget.id).collection('comment').doc(cm.id).delete();
                                                                                                ...
                                                                                                GestureDetector(
                                                                                                  ...
                                                                                                  onTap: () async {
                                                                                                    if (_controller1.text.trim() == '') {
                                                                                                      ...
                                                                                                      await FirebaseFirestore.instance.collection("fastfilm").doc(widget.id).collection('comment').doc(cm.id).set(
                                                                                                        {
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(
                          width: 0.8,
                          color: const Color.fromARGB(193, 218, 233, 46),
                        ),
