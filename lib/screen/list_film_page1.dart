...
class ListFilmPage1 extends StatefulWidget {
  const ListFilmPage1({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
  _ListFilmPage1State createState() => _ListFilmPage1State();
}
...
class _ListFilmPage1State extends State<ListFilmPage1> {
              ...
              onSelected: ((value) {
                if (value == MenuItem.item1) {
                  setState(() {
                    ...
                    checkselec = true;
                    snapshot1 = getP
                        .where('country', isEqualTo: widget.title)
