...
import 'package:movie_app/modal/secons_videos.dart';
...
class HisScreen extends StatefulWidget {
  ...
  @override
  _HisScreenState createState() => _HisScreenState();
}
...
class _HisScreenState extends State<HisScreen> {
  ...
  finaldelete(String document) {
    getfaUser.doc(widget.uid).collection('historyView').doc(document).delete();
  }
          ...
          if (!snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                DateTime dateTime =
                    snapshot.data!.docs[index]['timeview'].toDate();
                            ...
                            children: [
                              ...
                              Padding(
                                padding:
                                    const EdgeInsets.fromLTRB(5.0, 3, 0, 3),
                                child: Text(
                                  '${SecondTime.formatedTime(timeInSecond: farU['playBackTime'])} / ${farU['duration']}',
                                  overflow: TextOverflow.ellipsis,
                                  style: const TextStyle(
                                    fontSize: 12,
                                    color: Color.fromARGB(255, 201, 201, 201),
